...
static const char *fonts[]          = { "JetBrainsMonoNerdFont-Regular:pixelsize=14", "JoyPixels:pixelsize=11:antialias=true:autohint=true"};
...
static Key keys[] = {
  ...
  { MODKEY,                       XK_b,       spawn,          {.v = browser_private} },
  ...
  //{ MODKEY,                       XK_e,      spawn,          SHCMD("st -e ranger") },
	//{ MODKEY|ShiftMask,             XK_a,      spawn,          SHCMD("st -e cmus") },
